  ...
  return (
    <SafeAreaView style={styles.container}>
      <View style={styles.header}>  
        ...
        <Text style={styles.title}>API 이용 정책</Text>
      </View>
      <ScrollView style={styles.content}>
        <Text style={styles.title}>1. 데이터 출처</Text>
        <Text style={styles.text}>
          본 앱은 대한민국 국회에서 제공하는 열린국회정보 Open API를 활용하여 제작되었습니다. 모든 법률 정보는 국회에서 공식적으로 제공하는 데이터를 기반으로 합니다.{'\n'}
        </Text>

        <Text style={styles.title}>2. 면책 조항</Text>
        <Text style={styles.text}>
        ...
        <Text style={styles.title}>3. API 이용 정책</Text>
        <Text style={styles.text}>
