  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>  
        ...
        <Typography style={styles.title}>개인정보 처리방침</Typography>
      </View>
      <ScrollView style={styles.content}>
        <Typography style={styles.title}>1. 개인정보 수집 현황</Typography>
        ...
        <Typography style={styles.title}>2. 개인정보의 수집 및 이용목적</Typography>
        <Typography style={styles.text}>
        ...
        <Typography style={styles.title}>3. 개인정보의 보유 및 이용기간</Typography>
        <Typography style={styles.text}>
          수집된 개인정보는 회원 탈퇴 시까지 보관되며, 회원 탈퇴 시 즉시 삭제됩니다. 단, 통계용 데이터는 익명화 처리 후 통계 목적으로만 보관될 수 있습니다.{'\n'}
        </Typography>

        <Typography style={styles.title}>4. Google AdMob 개인정보 처리</Typography>
        <Typography style={styles.text}>
        ...
        <Typography style={styles.title}>5. Firebase 서비스 이용</Typography>
        <Typography style={styles.text}>
        ...
        <Typography style={styles.title}>6. 개인정보 처리방침 변경</Typography>
        <Typography style={styles.text}>
